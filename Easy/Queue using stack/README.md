<h2><a href="https://practice.geeksforgeeks.org/problems/queue-using-stack/1?utm_source=gfg&utm_medium=article&utm_campaign=bottom_sticky_on_article">Queue using stack</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Implement a Queue&nbsp;using two stack</span><span style="font-size:18px"><strong>&nbsp;s1</strong>&nbsp;and<strong>&nbsp;s2</strong>.</span></p>
